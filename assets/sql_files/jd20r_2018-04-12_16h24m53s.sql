...
--
-- Client :  localhost
-- Généré le :  Jeu 12 Avril 2018 à 16:24
...
--
-- Création :  Jeu 12 Avril 2018 à 07:45
--
...
--
-- RELATIONS POUR LA TABLE `bestiary`:
--
...
--
-- Création :  Jeu 12 Avril 2018 à 11:17
-- Dernière modification :  Jeu 12 Avril 2018 à 11:28
--
...
--
-- RELATIONS POUR LA TABLE `character`:
--   `class`
--       `class` -> `id`
--
...
INSERT INTO `character` (`char_id`, `name`, `sex`, `class`, `race`, `level`, `traits`, `strength`, `dexterity`, `luck`, `constitution`, `charisma`, `perception`, `education`, `intelligence`, `alignement`, `defense`, `hp_cur`, `hp_max`, `pp_cur`, `pp_max`, `gold`, `story`) VALUES
(1, 'Ecktor', 'F', 8, 'Mort-vivant', 1, 'Dévoué, passionné, grande gueule, ne dort jamais', 50, 50, 50, 50, 50, 50, 50, 50, 50, 1, 200, 200, 200, 200, 0, 'Absolument dévoué à la cause des Réprouvés, et fervent admirateur de Sylvanas, Ecktor a pour idéal de prouver au monde que son espèce, bien que contre nature, est digne de confiance et de respect.'),
(2, 'GetBrain', 'M', 5, 'Elfe de sang', 1, 'Ahmed', 10, 40, 50, 30, 50, 70, 70, 80, 50, 0, 130, 130, 330, 330, 0, ''),
(3, 'Wipoo', 'M', 3, 'Tauren', 1, '', 50, 50, 50, 50, 50, 50, 50, 50, 50, 0, 210, 210, 210, 210, 0, ''),
(4, 'Falzahr', 'M', 12, 'Orc', 1, '', 50, 50, 50, 50, 50, 50, 50, 50, 50, 0, 210, 210, 210, 210, 0, '');
...
--
-- Création :  Jeu 12 Avril 2018 à 10:02
-- Dernière modification :  Jeu 12 Avril 2018 à 12:44
--
...
--
-- RELATIONS POUR LA TABLE `char_inventory`:
--   `item_id`
--       `item` -> `id`
--   `char_id`
--       `character` -> `char_id`
...
--
-- Contenu de la table `char_inventory`
--

INSERT INTO `char_inventory` (`item_id`, `char_id`, `item_quantity`) VALUES
(31, 1, 1),
(35, 1, 1);
...
--
-- Création :  Jeu 05 Avril 2018 à 09:19
--
...
--
-- Création :  Jeu 29 Mars 2018 à 09:56
--
...
--
-- RELATIONS POUR LA TABLE `inventory`:
--
...
--
-- Création :  Jeu 12 Avril 2018 à 07:36
-- Dernière modification :  Jeu 12 Avril 2018 à 12:43
--
...
(34, 6, 'Arc artisanal', '<code>[1d4*2]</code> Une branche courbée et de la ficelle', 1, 'dex'),
(35, 7, 'Soutane d\'apprenti', 'C\'est bien aéré là-dessous', 1, 'int');
...
--
-- Création :  Jeu 12 Avril 2018 à 07:35
-- Dernière modification :  Jeu 12 Avril 2018 à 07:35
--
...
--
-- RELATIONS POUR LA TABLE `item_category`:
--
...
--
-- RELATIONS POUR LA TABLE `region`:
--
...
--
-- Création :  Jeu 12 Avril 2018 à 07:38
-- Dernière modification :  Jeu 12 Avril 2018 à 07:38
--
...
--
-- RELATIONS POUR LA TABLE `region_bestiary`:
--   `bestiary_id`
--       `bestiary` -> `id`
--   `region_id`
--       `region` -> `id`
...
--
-- Création :  Jeu 12 Avril 2018 à 09:58
-- Dernière modification :  Jeu 12 Avril 2018 à 09:58
--
...
--
-- Index pour la table `char_inventory`
--
...
--
-- Index pour la table `region_bestiary`
--
ALTER TABLE `region_bestiary`
  ADD KEY `bestiary_id` (`bestiary_id`),
...
--
ALTER TABLE `character`
  MODIFY `char_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- Contraintes pour la table `char_inventory`
--
ALTER TABLE `char_inventory`
  ADD CONSTRAINT `char_inventory_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `char_inventory_ibfk_2` FOREIGN KEY (`char_id`) REFERENCES `character` (`char_id`);

--
-- Contraintes pour la table `item`
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_ibfk_1` FOREIGN KEY (`category`) REFERENCES `item_category` (`id`);

--
-- Contraintes pour la table `region_bestiary`
--
ALTER TABLE `region_bestiary`
  ADD CONSTRAINT `region_bestiary_ibfk_1` FOREIGN KEY (`bestiary_id`) REFERENCES `bestiary` (`id`),
  ADD CONSTRAINT `region_bestiary_ibfk_2` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`);

--
-- Contraintes pour la table `skill`
--
ALTER TABLE `skill`
  ADD CONSTRAINT `skill_ibfk_1` FOREIGN KEY (`char_id`) REFERENCES `character` (`char_id`);

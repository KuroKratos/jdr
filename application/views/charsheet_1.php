      ...
      <div class="col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <span class="pull-right">( <img src="../assets/images/enter_key.png" class="img-responsive" style="height: 20px; display: inline"> pour enregistrer )</span>
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="progress progress-striped skill-bar hp-bar" style="margin-bottom: 0; margin-top: 10px;">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" id="hp_bar"></div>
                        <span class="skill">
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="progress progress-striped skill-bar pp-bar" style="margin-bottom: 0; margin-top: 10px;">
                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" id="pp_bar"></div>
                        <span class="skill">
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-collapse collapse in" id="collapse2">
            <div class="panel-body">
              ...
              <div class="col-xs-3 text-righto" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_ali">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="progress progress-striped" style="/*box-shadow: 0px 0px 10px #000000;*/ margin-top:12px; margin-bottom: 10px; border: 1px solid #888888;">
                    <div class="progress-bar progress-bar-warning" id="bar_light" role="progressbar" style="font-size: large; width:50%; background-color: #eebb33; text-align: center; line-height:33px; text-shadow: 1px 1px 3px black;">
                      <b>Lumière</b>
                    </div>
                    <div class="progress-bar progress-bar-success" id="bar_dark"  role="progressbar" style="font-size: large; width:50%; background-color: #000033; text-align: center; line-height:33px;">
                      <b>Ombre</b>
                    </div>
                  </div>
                </div>
          ...
          <div class="panel-body">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_str">
                  <input type="text" class="input-underline text-center carac char_val" value="50%" style="width: 100%; text-align: center !important;" id="strength">
                </div>
              </div>

              <div class="col-xs-4">
                <div class="col-xs-6 text-left"            style="font-weight: bold; font-size: 14px; padding: 5px;">INTEL</div>
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_int">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_con">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_dex">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_edu">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_cha">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_luk">
              ...
              <div class="col-xs-4">
                ...
                <div class="col-xs-6 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_per">
            ...
            <div class="row">
              ...
              <div class="col-xs-4">
                <div class="col-xs-12 text-right text-info" style="font-weight: bold; font-size: 14px; padding: 5px;" id="c_gld">
    ...
    <div class="col-md-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Dons de <span class="name">---</span></h4>
        </div>

...
<div id="charsheet" class="mini" style="">
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-collapse collapse in" id="collapse0">
      <div class="panel-body">
        ...
        <hr style="border: none; border-bottom: 1px solid white; margin:10px -15px;">
        <!-- ALIGNEMENT -->
        <div class="row">
          <div class="col-xs-12">
            <div class="row">
